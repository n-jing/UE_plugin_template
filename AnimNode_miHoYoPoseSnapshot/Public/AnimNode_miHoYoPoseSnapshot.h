...
#include "AnimNode_miHoYoPoseSnapshot.generated.h"
...
UENUM()
enum class EmiHoYoSnapshotSourceMode : uint8
{
	/**
...
/** Provide a custom snapshot pose, either from the internal named pose cache or via a supplied snapshot */
USTRUCT(BlueprintInternalUseOnly)
struct ANIMNODE_MIHOYOPOSESNAPSHOT_API FAnimNode_miHoYoPoseSnapshot : public FAnimNode_Base
{
...
public:
	...
	/** How to access the snapshot */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Snapshot", meta = (PinHiddenByDefault))
		EmiHoYoSnapshotSourceMode Mode;
